...
# =============== CONFIG ===============
IMAGE_DIR = 'static/comp-images'  # adjust if needed
DB_PATH = 'database.db'
TARGET_SIZE = (224, 224)           # standard MobileNetV2 input size (width, height)
BATCH_SIZE = 32
EPOCHS = 30
# =====================================
...
outputs = layers.Dense(2, activation='sigmoid')(x)  # normalized coords [0,1]
