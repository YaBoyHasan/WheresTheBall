...
# =============== CONFIG ===============
IMAGE_DIR = 'static/comp-images'  # adjust if different
DB_PATH = 'database.db'           # your SQLite DB path
...
outputs = layers.Dense(2, activation='sigmoid')(x)  # coords normalized [0,1]
