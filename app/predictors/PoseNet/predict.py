...
def predict_ball_location(image_path, model):
    ...
    return (x_scaled, y_scaled), x_range, y_range, img, scale  # RETURN scale here

if __name__ == "__main__":
    model = load_model(MODEL_PATH, custom_objects={'ChannelAttention': ChannelAttention}, compile=False)

    coords, x_range, y_range, img, scale = predict_ball_location(INPUT_IMAGE_PATH, model)  # unpack scale
